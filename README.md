...
Ссылка на рабочий проект: [https://maxpotapov.pythonanywhere.com](https://maxpotapov.pythonanywhere.com)
...
```bash
git clone [https://github.com/xboxlgdexp-ctrl/SampleTrace.git](https://github.com/xboxlgdexp-ctrl/SampleTrace.git)
cd SampleTrace
